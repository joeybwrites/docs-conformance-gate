...
Plugins are available in Claude Code and Cowork; see the [support matrix](./plugin_component_matrix) for surface-by-surface detail.

## See also

More on [connectors](/docs/docs/connectors/overview) and how they compose into plugins.
